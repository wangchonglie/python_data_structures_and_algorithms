...
class BST(object):
    ...
    def build_from(cls, node_list):
        cls.size = 0
        key_to_node_dict = dict()
        for node_dict in node_list:
            key = node_dict['key']
            key_to_node_dict[key] = BSTNode(key, value=key)  # 这里值暂时用和key一样的
    ...
    def _bst_insert(self, subtree, key, value):
        ...
        if subtree is None:
            ...
            subtree.left = self._bst_insert(subtree.left, key, value)  # 当前节点的左节点指向新插入的值
        elif key > subtree.key:
    ...
    def _bst_remove(self, subtree, key):
        ...
        # 找到了需要删除的节点
            ...
            # 两孩子, 寻找后继节点替换, 并删除其右子树的后继节点, 同时更新其右子树
            else:
